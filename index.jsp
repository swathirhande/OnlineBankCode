<%@ page import="g.*" %>
 ...
 <%@ page import = "java.io.*,java.lang.*, org.apache.logging.log4j.LogManager,
org.apache.logging.log4j.Logger,java.util.*,java.sql.Connection,java.sql.PreparedStatement, javax.servlet.*, javax.servlet.http.HttpServletRequest,javax.servlet.http.HttpServletResponse" %>
...
if(userDetails != null){
    ...
    status= username == null ? false: verifyLogin1.checkLogin(username,password,accountno);
    if(status){
...
<div id="navigation">
    ...
    <li> <a href="withdraw.jsp">WITHDRAW</a>
