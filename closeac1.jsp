...
<tr >
    ...
    <td width="1200" valign="top">
		...
		<tr>
			...
			try
			{
				verifyLogin1 a = new verifyLogin1 ();
			...
			PreparedStatement ps1=con1.prepareStatement("DELETE FROM NEW1 WHERE accountno=?");
			...
			ResultSet rs1=ps1.executeQuery();
			 ...
			 %></div>
				<form name=F1  onSubmit="return dil(this)" action="closeac1.jsp" >
				     <table cellspacing="5" cellpadding="3">
					
					
					<tr><td></td><td><input type="submit" value="Close A/C"/>
